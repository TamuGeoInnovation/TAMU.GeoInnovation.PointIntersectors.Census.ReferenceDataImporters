...
{
    public abstract class AbstractTiger2000CountryFileLayout : AbstractTigerFileLayout
    {

        public AbstractTiger2000CountryFileLayout()
            : base() { }

        public AbstractTiger2000CountryFileLayout(string tableName)
            : base(tableName) { }
