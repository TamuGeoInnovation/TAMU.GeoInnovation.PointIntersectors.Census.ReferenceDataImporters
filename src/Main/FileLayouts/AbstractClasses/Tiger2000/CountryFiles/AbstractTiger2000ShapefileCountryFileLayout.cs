...
namespace TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.FileLayouts.AbstractClasses.Tiger2000.CountryFiles
{
    public abstract class AbstractTiger2000ShapefileCountryFileLayout : AbstractTiger2000CountryFileLayout, ITigerShapefileFileLayout
    {
        ...
        public AbstractTiger2000ShapefileCountryFileLayout()
            : base() { }

        public AbstractTiger2000ShapefileCountryFileLayout(string tableName)
            : base(tableName) { }
