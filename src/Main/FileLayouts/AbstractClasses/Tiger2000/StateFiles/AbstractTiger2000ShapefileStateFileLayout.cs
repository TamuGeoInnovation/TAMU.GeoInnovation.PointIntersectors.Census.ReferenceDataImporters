...
{
    public abstract class AbstractTiger2000ShapefileStateFileLayout : AbstractTiger2000StateFileLayout, ITigerShapefileFileLayout
    {
        ...
        public AbstractTiger2000ShapefileStateFileLayout(string tableName)
            : base(tableName) { }
