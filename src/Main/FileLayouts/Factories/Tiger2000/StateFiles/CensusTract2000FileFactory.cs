...
{
    public sealed class CensusTract2000FileFactory
    {
        private CensusTract2000FileFactory() { }
        ...
        public static ITigerFileLayout GetFile(IQueryManager queryManager, string stateName)
        {
            ...
            switch (queryManager.ProviderType)
            {
                ...
                case DataProviderType.SqlServer:
                    ...
                    if (assembly != null)
                    {
                        ret = (ITigerFileLayout)assembly.CreateInstance("TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.SqlServer.FileLayouts.Implementations.Tiger2000.StateFiles.CensusTract2000File", true, BindingFlags.CreateInstance | BindingFlags.Instance | BindingFlags.Public, null, new object[] { stateName }, null, null);
                    }
                    else
                    {
                ...
                case DataProviderType.MySql:
                    ...
                    if (assembly != null)
                    {
                        ret = (ITigerFileLayout)assembly.CreateInstance("TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.MySql.FileLayouts.Implementations.Tiger2000.StateFiles.CensusTract2000File", true, BindingFlags.CreateInstance | BindingFlags.Instance | BindingFlags.Public, null, new object[] { stateName }, null, null);
                    }
                    else
                    {
                        throw new Exception("Unable to load Assembly: " + assemblyPath);
                ...
                case DataProviderType.Npgsql:
                    ...
                    if (assembly != null)
                    {
                        ret = (ITigerFileLayout)assembly.CreateInstance("TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.PostgreSql.FileLayouts.Implementations.Tiger2000.StateFiles.CensusTract2000File", true, BindingFlags.CreateInstance | BindingFlags.Instance | BindingFlags.Public, null, new object[] { stateName }, null, null);
                    }
                    else
                    {
                        throw new Exception("Unable to load Assembly: " + assemblyPath);
                ...
                case DataProviderType.MongoDB:
                    ...
                    if (assembly != null)
                    {
                        ret = (ITigerFileLayout)assembly.CreateInstance("TAMU.GeoInnovation.Applications.Census.ReferenceDataImporter.MongoDB.FileLayouts.Implementations.Tiger2000.StateFiles.CensusTract2000File", true, BindingFlags.CreateInstance | BindingFlags.Instance | BindingFlags.Public, null, new object[] { stateName }, null, null);
                    }
                    else
                    {
                        throw new Exception("Unable to load Assembly: " + assemblyPath);
