...
{
    public class StateLevelImporterProgressState : TimeRemainableProgressState
    {
        #region Properties
        ...
        public TimeRemainableProgressState ProgressStateStates { get; set; }
        ...
        public StateLevelImporterProgressState()
        {
            ProgressStateStates = new TimeRemainableProgressState();
